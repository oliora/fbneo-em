...
static TCHAR* szMemoryCardFile = "memorycard.fc";
...
int MemCardRead(TCHAR* szFilename, unsigned char* pData, int nSize)
{
...
int MemCardWrite(TCHAR* szFilename, unsigned char* pData, int nSize)
{
...
int MemCardDoGetSize(struct BurnArea* pba)
{
...
int MemCardDoInsert(struct BurnArea* pba)
{
...
int MemCardDoEject(struct BurnArea* pba)
{
