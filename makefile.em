...
depobj	+= 	neocdlist.o \
			...
			inpdipsw.o vid_sdl2.o dynhuff.o replay.o sdl2_gui.o sdl2_inprint.o input_sdl2.o stated.o
...
lib	= -lstdc++ `sdl2-config --libs` -lSDL2_image -lm
endif
#-lGL
...
ORIG_CFLAGS = -O3 -fomit-frame-pointer -Wno-write-strings \
...
$(objdir)cpu/m68k/m68kmake: $(srcdir)cpu/m68k/m68kmake.c
	...
	@gcc $(ORIG_CFLAGS) $(srcdir)cpu/m68k/m68kmake.c -o $(objdir)cpu/m68k/m68kmake -Dmain=main
